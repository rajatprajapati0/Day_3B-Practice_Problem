...
{
    //partial is use for manege the code by spliting in two page but in same class
    partial class Access_Modifiers_Concepts
    ...
    public class Person
    {
        //protected is use for to avoid the access of mamber without inheritance 
    ...
    //sealed modifer use to avoid the inheritance of farmer and employee class 
